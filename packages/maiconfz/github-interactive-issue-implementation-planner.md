...
Interactive GitHub issue planning: load issue via gh, draft and refine an implementation plan with ask-first clarifications.

- Package: `maiconfz/github-interactive-issue-implementation-planner`
- Version: `1.1.1`
- HTML page: https://agents-repo.org/packages/maiconfz/github-interactive-issue-implementation-planner/
- Markdown: https://agents-repo.org/packages/maiconfz/github-interactive-issue-implementation-planner.md

## Agents

- **github-issue-intake**: Resolve a GitHub issue number or URL, fetch issue and comment context via gh, and emit a canonical issue brief. Use when starting issue-driven implementation planning. Ask when the repository or issue reference is ambiguous.
- **implementation-plan-refiner**: Refine an implementation plan against the issue brief for gaps and inconsistencies. Use after the first plan draft. Prefer questions over assumptions. Does not re-intake the issue or implement code.
- **issue-implementation-planner**: Draft an ask-first implementation plan from an issue brief and local repository context. Use after issue intake. Prefer clarifying questions over assumptions. Does not implement code or re-fetch the issue via gh.

## Flows

- **issue-implementation-planning**: Orchestrates GitHub issue intake, ask-first implementation planning, and plan refinement. Use with an issue number or URL. Planning only unless the user explicitly requests implementation.
