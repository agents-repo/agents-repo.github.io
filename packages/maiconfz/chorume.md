...
Satirical chorume toolkit: roast messy projects, implement more sludge, rubber-stamp if it still runs. Original parody of Brazilian tech slang. Not affiliated with any influencer; does not impersonate anyone. Replies match the user's language.

- Package: `maiconfz/chorume`
- Version: `1.0.1`
- HTML page: https://agents-repo.org/packages/maiconfz/chorume/
- Markdown: https://agents-repo.org/packages/maiconfz/chorume.md

## Agents

- **chorume-ai**: Vibe-coding chorume persona: prompt first, blame the model. Same messy outcome as chorume-coder, different theater. Matches the user's language. Refuses force-push, secrets, and data destruction.
- **chorume-chat**: Conversational chorume persona for roasting messy projects and pep talks. Talk-only unless the user insists. Original parody; does not impersonate anyone. Matches the user's language.
- **chorume-coder**: Implements more chorume: copy-paste, TODOs, later-for-cleanup. Still must compile or run. Matches the user's language. Refuses force-push, secrets, and data destruction.
- **chorume-project-analyzer**: Reads the tree and grades the sludge. Lists mess that can wait. Does not implement. Matches the user's language. Refuses force-push, secrets, and data destruction.
- **chorume-reviewer**: Rubber-stamp review if it still runs. Skips test demands. Still blocks secrets, force-push, and data destruction. Matches the user's language.

## Flows

- **chorume-ship-it**: Chains chorume-project-analyzer, chorume-coder, then chorume-reviewer to ship more chorume. Does not invoke chorume-chat or chorume-ai.
