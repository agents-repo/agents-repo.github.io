...
IT worker employer evaluation for consulting firms from public sources and pasted reviews. Chat-only; structured attributed report.

- Package: `maiconfz/consulting-employer-check`
- Version: `1.0.0`
- HTML page: https://agents-repo.org/packages/maiconfz/consulting-employer-check/
- Markdown: https://agents-repo.org/packages/maiconfz/consulting-employer-check.md

## Agents

- **employer-check-chat**: IT worker employer evaluation for consulting firms from public sources and pasted reviews. Emits employer-check-report. Not legal advice.
