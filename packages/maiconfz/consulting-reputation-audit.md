...
IT consulting company reputation audit from website, reviews, forums, and GPTW directories. Chat-only; balanced attributed report.

- Package: `maiconfz/consulting-reputation-audit`
- Version: `1.0.0`
- HTML page: https://agents-repo.org/packages/maiconfz/consulting-reputation-audit/
- Markdown: https://agents-repo.org/packages/maiconfz/consulting-reputation-audit.md

## Agents

- **consulting-reputation-chat**: IT consulting company reputation audit from public sources and pasted reviews. Emits consulting-reputation-report. Not legal advice.
