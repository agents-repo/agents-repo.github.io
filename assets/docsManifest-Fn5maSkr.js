...
`))if(t.startsWith(n))return t.slice(n.length).trim();return``}var v=Object.assign({"../../../../content/docs/agents-json-lock.md":n,"../../../../content/docs/cli-commands.md":r,"../../../../content/docs/cli-doctor.md":i,"../../../../content/docs/contributing-packages.md":a,"../../../../content/docs/contributing-to-webapp.md":o,"../../../../content/docs/discover-packages.md":s,"../../../../content/docs/ecosystem-overview.md":c,"../../../../content/docs/for-ai-agents.md":l,"../../../../content/docs/getting-started.md":u,"../../../../content/docs/how-the-registry-works.md":d,"../../../../content/docs/install-targets.md":f,"../../../../content/docs/installing-packages.md":p,"../../../../content/docs/submitting-a-package.md":m,"../../../../content/docs/using-the-catalog.md":h});function y(e){let t=/\/([^/]+)\.md$/.exec(e);if(!t?.[1])throw Error(`Invalid doc module path: ${e}`);return t[1]}function b(){let n=[];for(let[e,r]of Object.entries(v)){if(typeof r!=`string`)throw TypeError(`Doc module ${e} did not load as raw text`);let i=y(e),a=t(i);if(!a)throw Error(`Doc markdown ${i} is missing from docsCatalog.ts`);let{frontmatter:o,body:s}=g(r),c=_(o,`title`),l=_(o,`description`),u=_(o,`section`),d=Number(_(o,`order`));if(c!==a.title||l!==a.description||u!==a.section||d!==a.order)throw Error(`Doc ${i} frontmatter does not match docsCatalog.ts`);n.push({...a,bodyMarkdown:s})}if(n.length!==e.length)throw Error(`Doc markdown file count does not match docsCatalog.ts`);return n.sort((e,t)=>e.order-t.order||e.title.localeCompare(t.title))}var x=b(),S=new Map(x.map(e=>[e.slug,e]));function C(){return x}function w(e){return S.get(e)}function T(){let e=[],t=new Map;for(let n of x)t.has(n.section)||(t.set(n.section,[]),e.push(n.section)),t.get(n.section)?.push(n);return e.map(e=>({section:e,entries:t.get(e)??[]}))}export{C as n,T as r,w as t};